...
type AccountListReq struct {
	g.Meta   `path:"/account/list" method:"get" tags:"RBAC" summary:"Get account list" sm:"Get account list"`
...
type AccountDetailReq struct {
	g.Meta    `path:"/account/detail" method:"get" tags:"RBAC" summary:"Get account details" sm:"Get account details"`
...
type AccountCreateReq struct {
	g.Meta   `path:"/account/create" method:"post" tags:"RBAC" summary:"Create account" sm:"Create account"`
...
type AccountUpdateReq struct {
	g.Meta    `path:"/account/update" method:"post" tags:"RBAC" summary:"Update account" sm:"Update account"`
...
type AccountPasswordReq struct {
	g.Meta      `path:"/account/password" method:"post" tags:"RBAC" summary:"Update account password" sm:"Update account password"`
	AccountId   int64  `p:"accountId" v:"required#Account ID can not be empty" dc:"Account ID"`
...
type AccountDeleteReq struct {
	g.Meta    `path:"/account/delete" method:"post" tags:"RBAC" summary:"Delete account" sm:"Delete account"`
	AccountId int64 `p:"accountId" v:"required#Account ID can not be empty" dc:"Account ID"`
}
