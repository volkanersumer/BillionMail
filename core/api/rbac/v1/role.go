...
type RoleListReq struct {
	g.Meta   `path:"/role/list" method:"get" tags:"RBAC" summary:"Get role list" sm:"Get role list"`
...
type RoleDetailReq struct {
	g.Meta `path:"/role/detail" method:"get" tags:"RBAC" summary:"Get role details" sm:"Get role details"`
...
type RoleCreateReq struct {
	g.Meta        `path:"/role/create" method:"post" tags:"RBAC" summary:"Create role" sm:"Create role"`
...
type RoleUpdateReq struct {
	g.Meta        `path:"/role/update" method:"post" tags:"RBAC" summary:"Update role" sm:"Update role"`
...
type RoleDeleteReq struct {
	g.Meta `path:"/role/delete" method:"post" tags:"RBAC" summary:"Delete role" sm:"Delete role"`
	RoleId int64 `p:"roleId" v:"required#Role ID cannot be empty" dc:"Role ID"`
}
