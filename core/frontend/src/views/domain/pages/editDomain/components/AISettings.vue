	...
	<div class="content-wrapper">
		<n-card class="mb-5">
			<div class="page-tit" style="margin: 0">
				<div class="left-tit">
					...
					<span class="tit-content"> AI Settings </span>
				</div>
			</div>
		</n-card>
		...
		<n-card>
			<div class="page-tit mb-5">
				<div class="left-tit">
					<span class="tit-content"> Default AI Instructions </span>
				</div>
			</div>
			...
			<n-form>
				<n-form-item>
					<template #label
						><span class="form-label">Instructions for Email Generation</span></template
					>
					<n-input v-model:value="prompt" type="textarea" :rows="13"></n-input>
				</n-form-item>
			</n-form>
			<div>
				These instructions will be used as default guidelines when generating new emails. You can
				override these instructions for individual emails as needed.
			</div>
		</n-card>
	</div>
</template>
