<template>
    <n-modal preset="card" v-model:show="show" :close-on-esc="false" :mask-closable="false" draggable class="w-150"
        title="Add Provider">
        <n-form :model="addProviderFormData" :rules="rules" ref="addProviderFormDataRef">
