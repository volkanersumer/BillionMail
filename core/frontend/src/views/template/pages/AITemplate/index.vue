			...
			<div class="chat-area">
							...
							<div ref="scrollWrapperRef">
								<div class="answer-container">
									<div class="ask-content">
										<div class="text">
											您可以说：创建一份欢迎用户加入{{ chatInfo.domain }}的欢迎邮件
										</div>
									</div>
								</div>
										...
										<div class="answer-content">
											...
											<div class="text">
												<MarkdownRender v-for="(_item, _index) in item[1]" :key="_index"
													:content="_item" :chat-record-key="item[0]" class="mb-4"
				...
				<div class="question">
					<n-card style="height: 100%">
						<n-input v-model:value="questionContent" type="textarea" class="question-input"
