...
`,[(0,x.cE)("children-placeholder",`
 ...
 `,[(0,W.c)({left:"50%",top:"50%",originalTransform:"translateX(-50%) translateY(-50%)"})]),(0,x.cE)("checked, unchecked",`
 transition: color .3s var(--n-bezier);
